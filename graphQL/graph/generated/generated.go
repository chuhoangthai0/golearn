...
func (ec *executionContext) field_Mutation_upsertCharacter_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCharacterInput2graphQLᚋgraphᚋmodelᚐCharacterInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Character_cliqueType(ctx context.Context, field graphql.CollectedField, obj *model.Character) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCliqueType2graphQLᚋgraphᚋmodelᚐCliqueType(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_upsertCharacter(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCharacter2ᚖgraphQLᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_character(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Character)
	fc.Result = res
	return ec.marshalOCharacter2ᚖgraphQLᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_pogues(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Character)
	fc.Result = res
	return ec.marshalNCharacter2ᚕᚖgraphQLᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputCharacterInput(ctx context.Context, obj interface{}) (model.CharacterInput, error) {
	...
	for k, v := range asMap {
		...
		case "cliqueType":
			...
			it.CliqueType, err = ec.unmarshalNCliqueType2graphQLᚋgraphᚋmodelᚐCliqueType(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNCharacter2graphQLᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v model.Character) graphql.Marshaler {
	return ec._Character(ctx, sel, &v)
}

func (ec *executionContext) marshalNCharacter2ᚕᚖgraphQLᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v []*model.Character) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOCharacter2ᚖgraphQLᚋgraphᚋmodelᚐCharacter(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNCharacter2ᚖgraphQLᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNCharacterInput2graphQLᚋgraphᚋmodelᚐCharacterInput(ctx context.Context, v interface{}) (model.CharacterInput, error) {
	res, err := ec.unmarshalInputCharacterInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNCliqueType2graphQLᚋgraphᚋmodelᚐCliqueType(ctx context.Context, v interface{}) (model.CliqueType, error) {
	var res model.CliqueType
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNCliqueType2graphQLᚋgraphᚋmodelᚐCliqueType(ctx context.Context, sel ast.SelectionSet, v model.CliqueType) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) marshalOCharacter2ᚖgraphQLᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Character(ctx, sel, v)
